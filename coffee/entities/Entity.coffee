...
module.exports = class Entity
  ...
  updateDirection: () =>
    # @direction.segments[0] = new Segment
    #   point: [@pos.x, @pos.y]
    # @direction.segments[1] = new Segment
    #   point: [@pos.x + (@v.x * 10), @pos.y + (@v.y * 10)]
  ...
  kill: () =>
    @body.remove() #remove the entity body from the view
    $(window).trigger @type + '-death', this
